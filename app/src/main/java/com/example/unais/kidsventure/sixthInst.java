...
public class sixthInst extends AppCompatActivity {

    public ImageView soundimg, imvback, imguitar, imsaxophone;
    ...
    public void bckfrst(){
        ...
        imvback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent frstback = new Intent(sixthInst.this, firstScreen.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sixth_inst);
        bckfrst();
