...
//
  //              RandomImage();
    ...
    protected void RandomImage(){
        ...
        final int answer = rnd.nextInt(10) + 1;
        ...
        final String str = "balloon" + (answer);
...
//        final TextView tv_ans = (TextView) findViewById(R.id.correct_ans);
        final String opt_str1 = "num" + (Num.get(0));
        final String opt_str2 = "num" + (Num.get(1));
        final String opt_str3 = "num" + (Num.get(2));
...
//        rt.setText(a);
        ...
        if(COUNT >= LIMIT){
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(getApplicationContext(), countingscr.class);
