...
//                finish();
    ...
    protected void RandomImage(){
        ...
        String[] ans = {"cow","dog","elephant","lion","horse","leopard","tiger","sheep","cat","goat"};
        ...
        //File filePath = new File("R.raw."+str);
        final MediaPlayer mp_sound = MediaPlayer.create(this, getResourceID(str, "raw", getApplicationContext()));
        img.setImageDrawable(getResources().getDrawable(getResourceID("sound_icon", "drawable", getApplicationContext())));
        ...
        img.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                //mp_pop_drip.start();
                img.setImageDrawable(getResources().getDrawable(getResourceID("sound_icon_clicked", "drawable", getApplicationContext())));
                mp_sound.start();
