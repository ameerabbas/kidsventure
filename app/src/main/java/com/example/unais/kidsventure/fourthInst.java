...
public class fourthInst extends AppCompatActivity {

    public ImageView soundimg, imvback, imvnext, imdrum, imguitar;
    ...
    public void fourthinst(){
        ...
        imvnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent instfourth = new Intent(fourthInst.this, fifthInst.class);
    ...
    public void bckfrst(){
        ...
        imvback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frstback = new Intent(fourthInst.this, firstScreen.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourth_inst);
        fourthinst();
        bckfrst();
