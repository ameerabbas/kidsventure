...
public class objectimg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_objectimg);
...
//                finish();
    ...
    protected void RandomImage(){
        ...
        String[] ans = {"bag","ball","book","cap","chair","fan","glass","pen","plate","table"};
    ...
    public void exitWindow(){
        RelativeLayout mainLayout = (RelativeLayout) findViewById(R.id.activity_objectimg);
...
//        rt.setText(a);
        ...
        if(COUNT >= LIMIT){
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(getApplicationContext(), objectimgscr.class);
