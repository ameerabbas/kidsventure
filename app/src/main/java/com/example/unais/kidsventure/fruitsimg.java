...
public class fruitsimg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fruitsimg);
...
//                finish();
    ...
    protected void RandomImage(){
        ...
        String[] ans = {"apple","banana","grapes","guava","lemon","orange","peach","pineapple","strawberry","watermelon"};
    ...
    public void exitWindow(){
        RelativeLayout mainLayout = (RelativeLayout) findViewById(R.id.activity_fruitsimg);
...
//        rt.setText(a);
        ...
        if(COUNT >= LIMIT){
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(getApplicationContext(), fruitimgscr.class);
