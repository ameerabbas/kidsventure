...
public class SmallBig extends AppCompatActivity {

    final int NUM_OF_IMAGES = 7;
    final int LESS = 1;
    final int EQUAL = 2;
    final int GREATER = 3;
    int points = 0;
...
//
  //              RandomImage();
    ...
    protected void RandomImage() {
        ...
        int random_num = 1 + rnd.nextInt(NUM_OF_IMAGES-1);

        int[] ans = {GREATER, GREATER, LESS, LESS, GREATER, LESS, EQUAL};
        ...
        final String str = "question" + (random_num);
        ...
        optionList.add(GREATER);
        optionList.add(LESS);
        optionList.add(EQUAL);
...
//        final TextView tv_points = (TextView) findViewById(R.id.Score);

        final String opt_str1 = "sign" + (optionList.get(0));
        final String opt_str2 = "sign" + (optionList.get(1));
        final String opt_str3 = "sign" + (optionList.get(2));
        ...
        final String answer_img = "sign" + answer;
	...
	public void exitWindow(){
        RelativeLayout mainLayout = (RelativeLayout) findViewById(R.id.activity_smallbig);
...
//        rt.setText(a);
        ...
        if(COUNT >= LIMIT){
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(getApplicationContext(), smallbigscr.class);
